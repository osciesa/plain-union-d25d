...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/plain-union-d25d
```

A live public deployment of this template is available at [https://plain-union-d25d.templates.workers.dev](https://plain-union-d25d.templates.workers.dev)
